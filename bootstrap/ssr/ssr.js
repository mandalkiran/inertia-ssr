import { useSSRContext, mergeProps, unref, withCtx, createVNode, ref, onMounted, createTextVNode, withModifiers, openBlock, createBlock, toDisplayString, createCommentVNode, computed, onUnmounted, renderSlot, watch, withKeys, nextTick, createSSRApp, h } from "vue";
...
const ApplicationLogo = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$q = {
  __name: "GuestLayout",
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}> hello there</div>`);
}
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$2]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6" }, _attrs))}> JAY MAA KALI </div>`);
}
